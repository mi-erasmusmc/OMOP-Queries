...
FROM concept_ancestor ca
  JOIN concept a ON ca.ancestor_concept_id = a.concept_id
  JOIN concept d ON ca.descendant_concept_id = d.concept_id
WHERE ca.min_levels_of_separation = 1
      AND ca.descendant_concept_id = 192671 -- PARAMETER
